...
userRouter.post('/signup', jsonParser, function(req, res) {
  ...
  userRouter.post('/signin', basicHttp, function(req, res) {
...
userRouter.get('/user', decryptUser, function(req, res) {
  res.json({
    _id: req.user._id,
...
userRouter.put('/user', decryptUser, function(req, res) {
...
userRouter.delete('/user', decryptUser, function(req, res) {
